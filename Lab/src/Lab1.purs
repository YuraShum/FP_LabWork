...
-- списку так як використовувати foldr (що дозволяє заповнення списку почнаючи з правої частини)
snoc :: forall a. List a -> a -> List a
-- спочтку обертаємо масив та додаємо елемент за допомогою Cons
-- Потім виконуємо обернення масиву
